...
describe('Product module Test case', function () {
      ...
      it('Should add the product while clicking on add product', function () {
          addProduct("MacbookPro",1000,"Computer",100,"Dell Inc. is a multinational computer technology company based in Round Rock, Texas, that develops, sells, repairs, and supports computers and related products and services.");
        });
    ...
    beforeEach(function() {
        ...
        function getAllProductsDetails() {
            return getAllProducts('https://ft-anitrai011.vz2.dreamfactory.com/api/v2/db/_table/Product',{
              ...
              'X-DreamFactory-Session-Token':'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..bpuxUlamdkLp_qkD0LdRgBSwUCvf-bA8Py1iem_SERw'}
          });
        }
        function addProducts() {
          let inputJson = {
              "resource": [
                 {
                 "description" :"unique creation by oppo!",
                 "category" : "mobile",
                 "price" : 900,
                 "title" : "Oppox",
                 "available":10
